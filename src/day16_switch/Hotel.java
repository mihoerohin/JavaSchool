    ...
    public static void main(String[] args) {
        ...
        switch (people){
            case 1:
                ...
                price = "price per night: $ 100\ntotal price: $" + days * 100 ;
                break;
            case 2:
                roomType = "double room";
                price = "price per night: $ 125\ntotal price: $" + days * 125;
                break;
            case 4:
            case 3:
                roomType = "large room";
                price = "price per night: $ 150\ntotal price: $" + days * 150;
                break;
            case 5:
            case 6:
            case 7:
                roomType = "suite";
                price = "price per night: $ 5000\ntotal price: $" + days * 5000;
                break;
            default:
